...
def main():
    ...
    file_root = 'D:\\Pro\\YOLO_v1\\all_imgs'
    learning_rate = 0.001
    num_epochs = 50
    batch_size = 24
    use_resnet = True
    ...
    train_dataset = yoloDataset(root=file_root,list_file='eyes.txt',train=True,transform = [transforms.ToTensor()] )
    train_loader = DataLoader(train_dataset,batch_size=batch_size,shuffle=True,num_workers=4)

    test_dataset = yoloDataset(root=file_root,list_file='eyes.txt',train=False,transform = [transforms.ToTensor()] )
